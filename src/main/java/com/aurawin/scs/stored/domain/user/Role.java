    ...
    public static void entityCreated(Stored Entity, boolean Cascade) throws Exception {
        if (Entity instanceof Account){
            ...
            if (ua.Name.equals(com.aurawin.scs.lang.Table.String(com.aurawin.scs.lang.Table.Entities.Domain.Root))){
                String sRole = com.aurawin.scs.lang.Table.String(com.aurawin.scs.lang.Table.Entities.Domain.User.Role.Administrator);
                Role r = Entities.Lookup(Role.class,sRole);
                if (r==null) {
                    r = Bootstrap.addRole(
                            sRole,
                            Plugins.listAll()
