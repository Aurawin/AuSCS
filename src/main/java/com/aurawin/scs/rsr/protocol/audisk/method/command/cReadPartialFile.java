...
public class cReadPartialFile extends Method{
    ...
    public Result onProcess(Session ssn, Transport transport){
        ...
        switch (t.Kind) {
            case Server:
                ...
                cReadPartialFile cmd = t.gson.fromJson(t.Request.Command, cReadPartialFile.class);
                if (AuDisk.readPartialFile(t.Response.Payload,cmd.DiskId,cmd.NamespaceId,cmd.DomainId,cmd.OwnerId,cmd.FolderId,cmd.FileId,cmd.Start,cmd.Length)){
                    r = Ok;
                } else {
                    r = Failure;
                }
